    ...
    while (1 < 2)
    {
        ...
        else if (command == "craft")
        {
            ...
            if (pickaxe == "wood")
            {
                ...
                if (craft == "stone" || craft == "stonepickaxe")
                {
                ...
                else if (craft == "copper" || craft == "copperpickaxe")
                {
                ...
                else if (craft == "iron" || craft == "ironpickaxe")
                {
            ...
            else if (pickaxe == "stone")
            {
                ...
                if (craft == "copper" || craft == "copperpickaxe")
                {
                    if (money0 >= 35000 && copper0 >= 7000)
                    {
                        file.open("pickaxe.txt", ios::out);
            ...
            else if (pickaxe == "copper")
            {
                ...
                if (craft == "iron" || craft == "ironpickaxe")
                {
                    if (money0 >= 75000 && iron0 >= 20000)
                    {
                        file.open("pickaxe.txt", ios::out);
        ...
        else if (command == "enchant")
        {
            ...
            if (fortune == 0)
            {
                ...
                if (enchant == "fortune" || enchant == "fortune1" || enchant == "fortuneI" || enchant == "fortunei")
                {
                    file.open("money.txt", ios::in);
                    file >> money0;
                    file.close();
            ...
            else if (pickaxe == "stone")
            {
                ...
                if (efficiency == 0)
                {
                    ...
                    if (enchant == "efficiency1" || enchant == "efficiencyI" || enchant == "efficiencyi")
                    {
                    ...
                    else if (enchant == "efficiency2" || enchant == "efficiencyII" || enchant == "efficiencyii")
                    {
                    ...
                    else if (enchant == "efficiency3" || enchant == "efficiencyIII" || enchant == "efficiencyiii")
                    {
                ...
                else if (efficiency == 1)
                {
                    ...
                    if (enchant == "efficiency2" || enchant == "efficiencyII" || enchant == "efficiencyii")
                    {
                        if (money0 >= 1500 && lapis0 >= 350)
                        {
                            file.open("efficiency.txt", ios::out);
                ...
                else if (efficiency == 2)
                {
                    ...
                    if (enchant == "efficiency3" || enchant == "efficiencyIII" || enchant == "efficiencyiii")
                    {
                        if (money0 >= 4000 && lapis0 >= 500)
                        {
                            file.open("efficiency.txt", ios::out);
            ...
            else if (pickaxe == "copper")
            {
                ...
                if (efficiency == 0)
                {
                    ...
                    else if (enchant == "efficiency3" || enchant == "efficiency III" || enchant == "efficiencyiii")
                    {
